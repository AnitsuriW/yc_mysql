...
},
{
  ...
  children: [{
    path: 'student/list',
    component: () =>
                    import ('@/views/user/student/list'),
  ...
  },
  {
    path: 'student/edit',
    component: () =>
                    import ('@/views/user/student/edit'),
...
},
{
  ...
  },
  {
    path: 'question/list',
    component: () =>
                    import ('@/views/exam/question/list'),
  ...
  },
  {
    ...
    component: () =>
                    import ('@/views/exam/question/edit/single-choice'),
  ...
  },
  {
    ...
    component: () =>
                    import ('@/views/exam/question/edit/multiple-choice'),
  ...
  },
  {
    ...
    component: () =>
                    import ('@/views/exam/question/edit/true-false'),
    name: 'trueFalsePage',
  ...
  },
  {
    ...
    component: () =>
                    import ('@/views/exam/question/edit/gap-filling'),
    name: 'gapFillingPage',
  ...
  },
  {
    ...
    component: () =>
                    import ('@/views/exam/question/edit/short-answer'),
...
},
{
  ...
  children: [{
    path: 'subject/list',
    component: () =>
                    import ('@/views/education/subject/list'),
  ...
  },
  {
    path: 'subject/edit',
    component: () =>
                    import ('@/views/education/subject/edit'),
  ...
  },
  {
    path: 'course/list',
    component: () =>
                    import ('@/views/education/course/list'),
  ...
  },
  {
    path: 'course/edit',
    component: () =>
                    import ('@/views/education/course/edit'),
