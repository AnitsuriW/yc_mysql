  ...
  <div style="margin-top: 10px">
    <el-row>
      <el-carousel :interval="5000" arrow="always" type="card">
        <el-carousel-item >
          <img src="@/assets/carousel/1.jpg" class="carousel-img" style="
          height: 100%;">
        </el-carousel-item>
        <el-carousel-item >
        ...
        <el-carousel-item >
          <img src="@/assets/carousel/4.jpg" class="carousel-img">
        </el-carousel-item>
        <el-carousel-item >
      ...
      <el-col :span="24">
        <router-link to="chat/index">
          <img 
            ...
            style="width: 65%; height: 170px; border-radius: 8px;margin-left: 400px; cursor: pointer;"
            alt="AI智能助手"
            title="点击进入智学求索"
          >
        </router-link>
